-- Жалобы на объявления в Маркете, Жилье и Работе
...
create unique index if not exists uniq_listing_reports_per_user on listing_reports (section, listing_id, reporter_user_id);
